...
/* MMIO access macros */
#define MMIO_IN8(base, offset)  readb(((long)base+offset))
#define MMIO_IN16(base, offset) readw(((long)base+offset))
#define MMIO_IN32(base, offset) readl(((long)base+offset))

#define MMIO_OUT8(base, offset, val)  writeb(((u8)(val)), ((long)base+offset))
#define MMIO_OUT16(base, offset, val) writew(((u16)(val)), ((long)base+offset))
#define MMIO_OUT32(base, offset, val) writel(((u32)(val)), ((long)base+offset))
