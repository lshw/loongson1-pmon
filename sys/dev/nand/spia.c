 ...
 */
static void spia_hwcontrol(struct mtd_info *mtd, int cmd,int ctrl)
{
	struct nand_chip *chip = mtd->priv;

	if (ctrl & NAND_CTRL_CHANGE) {
		void *addr = spia_io_base + spia_pedr;
		unsigned char bits;
...
static int __init spia_init(void)
{
	...
	this->IO_ADDR_R = (void  *)spia_fio_base;
	this->IO_ADDR_W = (void  *)spia_fio_base;
