...
#define ATA_CMD_READ_EXT 	0x25	/* Read Sectors (with retries)	with 48bit addressing */
#define ATA_CMD_WRITE_EXT	0x35	/* Write Sectores (with retries) with 48bit addressing */
